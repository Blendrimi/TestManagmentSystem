...
namespace AngebotenUndRechnungenApp
{
    ...
    {
        public OfferandinvoicedbContext con;
        public MainForm()
        {
            InitializeComponent();
            con = new OfferandinvoicedbContext();
        }
        ...
        private void btnProjectDetails_Click(object sender, EventArgs e)
        {
            Cursor = Cursors.WaitCursor;
            panel4.Controls.Clear();
            ProjectDetailsAndServices obj = new ProjectDetailsAndServices();
            obj.TopLevel = false;
            panel4.Controls.Add(obj);
            obj.Dock = DockStyle.Fill;
            obj.Show();
        ...
        private void btnAddNewService_Click(object sender, EventArgs e)
        {
            Cursor = Cursors.WaitCursor;
            panel4.Controls.Clear();
            AddNewService obj = new AddNewService();
            obj.TopLevel = false;
            panel4.Controls.Add(obj);
            obj.Dock = DockStyle.Fill;
            obj.Show();
        ...
        public void Chart2Method()
        {
            try
            {
                ...
                //chart2.Series["Series2"].Color = Color.FromArgb(100, 100, 100);
                //chart2.Series["Series2"].BorderColor = Color.FromArgb(168, 228, 160);
                // ((SplineSeriesView)chart2.Series[0].View).Color = Color.Red;
                //((SplineSeriesView)chart2.Series[0].View).LineMarkerOptions.Color = Color.Green;
